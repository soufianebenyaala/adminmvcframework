...
class GestionProduits extends Controller {
    ...
    public function gestionproduits() {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            }elseif($data['date_depart'] > $data['date_arrivee'] ){
                $data['date_arriveeEORRE'] = "Please enter date d'arrivee > date de depart";
            }
    ...
    public function editproduit($id) {
        ...
        $data['getproduit'] = $this->userModel->getProduitDataById($id);
        $data['getsalledata'] = $this->userModel->affichesalleData();
        $this->view('edit_produit', $data);


    }
    public function deleteproduit($id){

        $this->userModel->deleteproduit($id);
